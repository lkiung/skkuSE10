 ...
 */
!function(e){if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.Kakao=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
...
module.exports = (function(){
  ...
  _dereq_('../vendor/es6-promise.js');

  var _easyXDM = _dereq_('../vendor/easyXDM.js');
  var _ = _dereq_('./util.js');
  var _k = _dereq_('./common.js');
  var _auth = _dereq_('./auth.js');
...
},{"../vendor/easyXDM.js":13,"../vendor/es6-promise.js":14,"./auth.js":3,"./common.js":6,"./util.js":11}],3:[function(_dereq_,module,exports){
/*******************
 * Auth
 *******************/
module.exports = (function() {
  ...
  var _easyXDM = _dereq_('../vendor/easyXDM.js');
  var _crypto = _dereq_('../vendor/CryptoJS.js');
  var _ = _dereq_('./util.js');
  var _k = _dereq_('./common.js');
  var _loginWithTalk = _dereq_('./auth.withTalk.js');
  var _poller = _dereq_('./auth.withTalk.poller.js');
  ...
  function _loginThroughTalk(settings, stateToken){
    if (!_loginProxyWithTalk){
      ...
      if ( _k.UA.os.android ){       // It is fallback proxy channel for login popup window opened by `S.browser_fallback_url`
        _.addEvent(window, 'message', messageHandler);
        var channel = "postProxy" + stateToken;
...
},{"../vendor/CryptoJS.js":12,"../vendor/easyXDM.js":13,"./auth.withTalk.js":4,"./auth.withTalk.poller.js":5,"./common.js":6,"./util.js":11}],4:[function(_dereq_,module,exports){
module.exports = (function() {
    var _k = _dereq_('./common.js');
    ...
    return {
        isSupport: function(){
            ...
            if (_k.UA.os.ios){
                return /safari/.test(_k.UA.ua)
                    && !/CriOS/i.test(_k.UA.ua)
                    && _k.UA.browser.version.major >= MIN_SUPPORT_VER_FOR_IOS_SAFARI;
            }else if( _k.UA.os.android ){
                return _k.UA.browser.chrome
                    && (_k.UA.browser.version.major >= MIN_SUPPORT_VER_TO_APP_INTENT_FOR_ANDROID_CHROME)
                    && (!isAndroidWebView || (isAndroidWebView && isSupportWebView))
            }else{
                return false;
            }
        },
        login: function(stateToken, fallbackWebURL){
            if ( !this.isSupport() ){
                return ;
            }
            if ( _k.UA.os.ios ) {
    ...
    function createIOSTalkLoginScheme(stateToken){
        return [_k.URL.talkLoginScheme, '?',
            'client_id='+_k.RUNTIME.appKey, '&',
            'redirect_uri=' + encodeURIComponent(_k.URL.talkLoginRedirectUri), '&',
            'params='+encodeURIComponent('{"state":"'+stateToken+'"}')
        ].join('');
    }
...
},{"./common.js":6}],5:[function(_dereq_,module,exports){
module.exports = (function(){
  var timer;
  ...
  var stopConditionFunc = function(){return false;};
  ...
  return {
    start: function(action, failAction){
      pollingCounter = 0;
    ...
    setStopCondition: function(funcCondition){
...
module.exports = (function() {
  ...
  var _ = _dereq_('./util.js');
  var userAgent = _dereq_('../vendor/userAgent.js');
...
},{"../vendor/userAgent.js":15,"./util.js":11}],7:[function(_dereq_,module,exports){
/*******************
 * Emoticon
 *******************/
module.exports = (function() {
...
},{"./api.js":2,"./util.js":11}],8:[function(_dereq_,module,exports){
module.exports = (function(root) {
  ...
  Kakao.init = function(appKey) {
    ...
    Kakao.Auth = _dereq_('./auth.js');
    Kakao.API = _dereq_('./api.js');
    Kakao.Link = _dereq_('./link.js');
    Kakao.Emoticon = _dereq_('./emoticon.js');
  };
...
},{"./api.js":2,"./auth.js":3,"./common.js":6,"./emoticon.js":7,"./link.js":9,"./story.js":10,"./util.js":11}],9:[function(_dereq_,module,exports){
module.exports = (function() {
  var Link = {};

  var _ = _dereq_('./util.js');
  var _k = _dereq_('./common.js');
  var web2app = _dereq_('../vendor/web2app.js');
...
},{"../vendor/web2app.js":16,"./common.js":6,"./util.js":11}],10:[function(_dereq_,module,exports){
module.exports = (function() {
  var Story = {};
...
},{"../vendor/web2app.js":16,"./common.js":6,"./util.js":11}],11:[function(_dereq_,module,exports){
/*
...
module.exports = (function() {
  ...
  var parseUA = _dereq_('./userAgent.js');
